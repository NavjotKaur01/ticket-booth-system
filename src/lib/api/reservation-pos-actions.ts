 ...
 * Assign seat uses UpdateTableNumberReservation.
 */

import { dispatchEndpoint } from "@/lib/api/dispatch-endpoint"
import { buildUpdateTableNumberReservationRequest } from "@/lib/build-update-table-number-request"
...
export async function assignReservationSeat(
  ...
  const request = buildUpdateTableNumberReservationRequest(params)
