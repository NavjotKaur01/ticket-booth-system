    ...
    items: [
      {
        ...
        items: [
          ...
          { id: "domain-configuration", label: "Domain Configuration" },
          { id: "venue-gateway", label: "Venue Gateway" },
          { id: "reservation-defaults", label: "Reservation Defaults" },
          { id: "online-settings", label: "Online Settings" },
          {
            id: "systems-default",
            label: "Systems Default",
            href: ROUTES.systemDefaults,
          },
          { id: "club-reservation-settings", label: "Club Reservation Settings" },
        ],
      },
      {
        id: "user-setup",
      ...
      },
      {
        ...
        label: "Navigation",
        items: [
          { id: "navigation-management", label: "Navigation Management" },
          { id: "navigation-drop-downs", label: "Navigation Drop Downs" },
          { id: "navigation-roles", label: "Navigation Roles" },
          { id: "navigation-location", label: "Navigation Location" },
        ],
      },
      { id: "news", label: "News" },
