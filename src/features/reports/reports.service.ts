...
export const REPORT_CONFIGS: Record<string, ReportConfig> = {
  ...
  "past-customers": { ...BASE, endpoint: "GetOldCustomerReport", title: "Past Customer Report", showDateRange: true, showCustomerFilters: true },
  "projected-sales": { ...BASE, endpoint: "GetProjectedReport", title: "Projected Sale Report", showDateRange: true },
...
export const DEFAULT_REPORT_VIEWER_OPTIONS: ReportViewerOption[] = [
  ...
  { id: "new-customers", label: "New Customer Report" },
  { id: "past-customers", label: "Past Customer Report" },
...
function transformProjectedSales(
  ...
  const columns: ReportViewerColumn[] = [
    ...
    { key: "perc", label: "Percentage", align: "right" },
